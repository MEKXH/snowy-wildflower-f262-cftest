...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/snowy-wildflower-f262-cftest)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/snowy-wildflower-f262-cftest
```

A live public deployment of this template is available at [https://snowy-wildflower-f262-cftest.templates.workers.dev](https://snowy-wildflower-f262-cftest.templates.workers.dev)
